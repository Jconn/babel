...
static void configure_subsystems(void);

static void gap_event_handler(esp_gap_ble_cb_event_t event, esp_ble_gap_cb_param_t *param)
{
    printf("gap event handler %d\n", event);
    ...
    case ESP_GAP_BLE_SCAN_RSP_DATA_SET_COMPLETE_EVT:
        ...
        break;
#endif
        //we finish this and then silence
...
static void gatts_profile_b_event_handler(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t *param) {
    eeprom_bt_profile(event, 
            gatts_if,
            param,
            &(gl_profile_tab[PROFILE_B_APP_ID]) );
}

static void gatts_event_handler(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t *param)
{
    /* If event is register event, store the gatts_if for each profile */
    printf("gatt event handler\n");
...
void app_main()
{
    ...
    switch (esp_sleep_get_wakeup_cause()) {
        case ESP_SLEEP_WAKEUP_TIMER: 
            ESP_LOGI(GATTS_TAG, "---------Wake up from timer---------. \n");
            break;
        case ESP_SLEEP_WAKEUP_UNDEFINED:
            //fall through
        default:
            ESP_LOGI(GATTS_TAG, "---------Not a deep sleep reset---------\n");
            break;
